...
const Searchbox = () => {
  ...
  return (
    ...
    <form className='flex border border-gray-200 rounded-full shadow-lg px-6 py-3 ml-10 mr-5 flex-grow max-w-3xl items-center' onSubmit={handlesubmit}>
      ...
      <FaMicrophone className='hidden sm:inline-flex text-4xl text-purple-700 pl-4 border-l-2 border-gray-300 mr-5'/>
      <SiGooglelens  className='hidden sm:inline-flex text-2xl text-purple-700 cursor-pointer mr-5'/>
      <IoIosSearch className='text-3xl hidden sm:inline-flex text-purple-700 cursor-pointer ' onClick={handlesubmit}/>
