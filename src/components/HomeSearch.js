...
const HomeSearch = () => {
  ...
  return ( <>
   ...
   <div className='flex flex-col space-y-2 sm:space-y-0 sm:space-x-4 justify-center sm:flex-row mt-8'>
    ...
    {googlesearchloading?(<Image src="spin.svg" alt="spin" className='h-6 text-center'/>):"Google Search"}
    </button>
    <button disabled={randomsearchloading} onClick={randomsearch} className='btn flex items-center justify-center disabled:opacity-80'>
      {randomsearchloading?(<Image src="spin.svg" alt="spin" className='h-6 text-center'/>):"I'm Feeling Lucky"}
      </button>
